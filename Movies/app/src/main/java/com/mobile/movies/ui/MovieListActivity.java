...
import com.mobile.movies.ui.adapter.ListAdapter;
...
public class MovieListActivity extends AppCompatActivity
    ...
    private ArrayList<Movie> myDataset;
    ...
    /*public RecyclerView.SmoothScroller.Action getIndexApiAction() {
        Thing object = new Thing.Builder()
                .setName("MovieList Page") // TODO: Define a title for the content shown.
                // TODO: Make sure this auto-generated URL is correct.
                .setUrl(Uri.parse("http://[ENTER-YOUR-URL-HERE]"))
                .build();
        return new NotificationCompat.Action.Builder(RecyclerView.SmoothScroller.Action.TYPE_VIEW)
                .setObject(object)
                .setActionStatus(RecyclerView.SmoothScroller.Action.STATUS_TYPE_COMPLETED)
                .build();
    }
